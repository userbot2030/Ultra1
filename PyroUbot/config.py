...
API_ID = int(os.getenv("API_ID", "23944801"))

API_HASH = os.getenv("API_HASH", "b25e021922b0fdfc03150f23b5765001")

BOT_TOKEN = os.getenv("BOT_TOKEN", "6207982225:AAFZlhW_jeUQGhL_-cwPHy_wYt8Q1Ft5AQc")
