...
from filters import get_filters_names
...
@ubot.on_message(ubot.cmd_prefix("addfil"))
@PY.TOP_CMD
...
@ubot.on_message(ubot.cmd_prefix("filters"))
@PY.TOP_CMD
...
@ubot.on_message(ubot.cmd_prefix("rmfil"))
@PY.TOP_CMD
