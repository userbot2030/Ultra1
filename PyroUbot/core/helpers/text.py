...
💬ᴘᴇʀᴋᴇɴᴀʟᴋᴀɴ sᴀʏᴀ ᴀᴅᴀʟᴀʜ {bot.me.first_name} ʏᴀɴɢ ᴀᴋᴀɴ ᴍᴇᴍʙᴀɴᴛᴜ ᴀɴᴅᴀ ᴍᴇɴɢᴀᴋᴛɪғᴋᴀɴ ᴜsᴇʀʙᴏᴛ sᴘᴇsɪᴀʟ ᴅɪ ᴀᴋᴜɴ ᴀɴᴅᴀ.

{bot.me.first_name} ᴀᴅᴀʟᴀʜ ᴜsᴇʀʙᴏᴛ sᴘᴇsɪᴀʟ ᴅᴇɴɢᴀɴ ʙᴇʀʙᴀɢᴀɪ ᴍᴀᴄᴀᴍ ᴍᴏᴅᴜʟ ʏᴀɴɢ ᴋᴇʀᴇɴ ʙᴀɴɢᴇᴛ ɢᴜʏs, ᴘᴍᴘᴇʀᴍɪᴛ, ᴘᴍ-ʟᴏɢs, ᴀғᴋ ᴅᴀɴ ᴊᴜɢᴀ ғᴜʟʟ ᴇᴍᴏᴊɪ ᴘʀᴇᴍɪᴜᴍ 
